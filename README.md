...
**NOTE: This role needs work, it doesn't currently upgrade PyPI installed using pipx, for now running `rm -rf ~/.local/pipx/venvs/ansible` before running this role is the best way to use it.**
